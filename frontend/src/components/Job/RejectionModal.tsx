...
export const RejectionModal = ({ setShowModal }: { setShowModal: Function }) => {
          ...
          >
              ...
              <div className="mt-3 text-center sm:mt-5">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    This job does not meet your salary expectations.
                  </p>
                </div>
              </div>
            </div>
            <div className="mt-5 w-full">
              <button
                ...
                className="w-full mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50m:mt-0"
              >
                Close
              </button>
            </div>
